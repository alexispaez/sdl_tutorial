...
procedure Motion is
   ...
   Font         : SDL.TTFs.Fonts;
   Texture      : SDL.Video.Textures.Extensions.Texture;
   ...
   begin
      ...
      SDL.Video.Textures.Extensions.Load_From_File (Texture, Renderer, "../resources/dot.png");
   end Load_Media;
   ...
   procedure Render_All (Renderer : in out Renderers.Renderer;
      ...
      procedure Render (Renderer : in out Renderers.Renderer;
                        X        : SDL.Coordinate;
                        Y        : SDL.Coordinate;
                        Texture  : SDL.Video.Textures.Extensions.Texture) is
